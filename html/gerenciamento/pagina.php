...
<html>
  <head>
    ...
    <script>
      ...
      // Converter os dados de JSON para um objeto JavaScript
      var respostas = JSON.parse(dadosCadastro);
    </script>
  </head>
  <body>
    <?php
    ...
    echo '<h1>Pontuações do Questionário Vocacional:</h1>';
    foreach ($pontuacoes as $pontuacao => $pontuacao_valor) {
      echo "<p>$pontuacao: $pontuacao_valor</p>";
  }
  ?>
  </body>
</html>
